...
app.config.from_envvar('MINITWIT_SETTINGS=/examples/minitwit/File_1.cfg', silent=True)
...
#USER_DATA = {
#    "PrabhBhullar06": "avengers3456"
#}

#@basic_auth.check_credentials(username, password)
    #if not (username and password):
    #return False
#return USER_DATA.get(username) == password
#class flask_ext_basicauth_BasicAuth(app == 'minitwit')
#@basicauth.check_credentials(username,password)
#   if username == 'PrabhBhullar06' and password == 'avengers3456'
#       return True
#   else False
